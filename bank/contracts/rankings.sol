...
{\*\expandedcolortbl;;}
{\info
{\author alen}}\vieww17340\viewh14980\viewkind1
\deftab720
...
\
	...
	\}\
\
    function bankroll(address treasureHunt,address herosure,address rankingsure)  public payable\{\
        require (msg.value > 0);\
        owner = msg.sender;\
\
...
\
		...
		TRUSTEDADDRESSES[herosure] = true;\
		TRUSTEDADDRESSES[rankingsure] = true;\
\
...
\
	...
	// OWNER FUNCTIONS\
	///////////////////////////////////////////////\
    function setProjectsRequest(address projectadr) public\{\
        require(msg.sender == owner);\
        TRUSTEDADDRESSES[projectadr] = false;\
    \}\
\
...
\
		owner = newOwner;\
	\}\
    //\'c9\'e8\'d6\'c3\'bd\'b1\'c0\'f8\'bb\'fd\'b7\'d6\
...
\
        uint256 rewardValue = SafeMath.sub(SafeMath.sub(address(this).balance, DEVELOPERSFUND),INVESTMENTFUNDS);\
\
        owner.transfer(rewardValue * ( 1000 - RewardPoints) / 1000);\
    \}\
\
